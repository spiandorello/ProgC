...
#ifdef DEBUG
		printf("vertice esquerda: %d\n", vertice_get_id(esquerda));
#endif
	}
...
#ifdef DEBUG
		printf("vertice direita: %d\n", vertice_get_id(direita));
#endif
	}
}
...
void exibir_pre_ordem (vertice_t *vertice){

	if (vertice == NULL)
		return;

	printf("pre-ordem: %d \n", vertice_get_id(vertice));
	exibir_pre_ordem(vertice_get_esq(vertice));
	exibir_pre_ordem(vertice_get_dir(vertice));
}

void exibir_pos_ordem (vertice_t *vertice){

	if (vertice == NULL)
		return;

	exibir_pos_ordem(vertice_get_esq(vertice));
	exibir_pos_ordem(vertice_get_dir(vertice));
	printf("pos-ordem: %d \n", vertice_get_id(vertice));
}

void exibir_em_ordem (vertice_t *vertice){

	if (vertice == NULL)
			return;

	exibir_em_ordem(vertice_get_esq(vertice));
	printf("em-ordem: %d \n", vertice_get_id(vertice));
	exibir_em_ordem(vertice_get_dir(vertice));
